...
> 快照截至 **2026-08-31 收盘**；每日 17:30 由 GitHub Actions 自动更新 `data/last_signal.json`（完整门控与指标明细），README 内快照随维护提交刷新。历史信号流水见 `data/signal_log.csv`。
...
| 明日目标仓位 | 0% |
| 动作 | 空仓等待 |
| 门控明细 | close>MA3 ❌、MA3>MA20 ❌、RSI<80 ✅、+DI>-DI ✅、医药ETF>MA20 ❌、创业板>MA30 ❌、换手率0.8%~10% ✅ |

数据完整性：贝瑞基因/医药ETF/医疗ETF已更新至 2026-08-31 收盘；上证/深成/创业板当日东财源被代理拦截，新浪源滞后至 08-28，门控按保守缺失关闭（创业板门控本就不满足）。8/31 信号为空仓：个股收盘跌破 MA3 且 MA3 下穿 MA20、医药ETF 跌破 MA20、创业板低于 MA30（数据缺失亦保守关闭），换手 5.73% 在区间内。
